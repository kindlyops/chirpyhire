...
ActiveRecord::Schema.define(version: 20_160_816_222_756) do
  ...
  create_table 'accounts', force: :cascade do |t|
    ...
    t.index %w(invited_by_type invited_by_id), name: 'index_accounts_on_invited_by_type_and_invited_by_id', using: :btree
  ...
  create_table 'choice_question_options', force: :cascade do |t|
    ...
    t.datetime 'created_at',  null: false
    t.datetime 'updated_at',  null: false
    t.index %w(letter question_id), name: 'index_choice_question_options_on_letter_and_question_id', unique: true, using: :btree
    t.index ['question_id'], name: 'index_choice_question_options_on_question_id', using: :btree
    t.index %w(text question_id), name: 'index_choice_question_options_on_text_and_question_id', unique: true, using: :btree
  end
  ...
  create_table 'templates', force: :cascade do |t|
    ...
    t.index %w(body organization_id), name: 'index_templates_on_body_and_organization_id', unique: true, using: :btree
    t.index %w(name organization_id), name: 'index_templates_on_name_and_organization_id', unique: true, using: :btree
  ...
  create_table 'users', force: :cascade do |t|
    ...
    t.index %w(organization_id phone_number), name: 'index_users_on_organization_id_and_phone_number', unique: true, using: :btree
