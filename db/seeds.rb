...
if Rails.env.development?
  ...
  25.times { FactoryGirl.create(:candidate, :with_address, latitude: random_coordinate(latitude), longitude: random_coordinate(longitude), stage: org.stages.default_bad_fit.first, organization: org, created_at: rand(1.month).seconds.ago) }
  25.times { FactoryGirl.create(:candidate, :with_address, latitude: random_coordinate(latitude), longitude: random_coordinate(longitude), stage: org.stages.default_qualified.first, organization: org, created_at: rand(1.month).seconds.ago) }
  25.times { FactoryGirl.create(:candidate, :with_address, latitude: random_coordinate(latitude), longitude: random_coordinate(longitude), stage: org.stages.default_potential.first, organization: org, created_at: rand(1.month).seconds.ago) }
  25.times { FactoryGirl.create(:candidate, :with_address, latitude: random_coordinate(latitude), longitude: random_coordinate(longitude), stage: org.stages.default_hired.first, organization: org, created_at: rand(1.month).seconds.ago) }
