...
if Rails.env.development?
  ...
  unless org.survey.present?
    ...
    welcome = Template.create(organization: org, name: "Welcome", body: "Hello this is {{organization.name}}. We're so glad you are interested in learning about opportunities here. We have a few questions to ask you via text message.")
