$(function() {
  $(document).on('change', '.settings.pricing .active-candidates-slider', function(e) {
    ...
    if(count <= 200) {
      ...
      $('.settings.pricing .candidates--price').text('$200 / mo');
    } else if(count <= 600) {
      $('.settings.pricing .candidates--price').text('$275 / mo');
    } else if(count <= 800) {
      $('.settings.pricing .candidates--price').text('$350 / mo');
    } else if(count <= 1000) {
      $('.settings.pricing .candidates--price').text('$425 / mo');
    } else if(count <= 1200) {
      $('.settings.pricing .candidates--price').text('$500 / mo');
    } else if(count <= 1400) {
      $('.settings.pricing .candidates--price').text('$575 / mo');
    } else if(count <= 1600) {
      $('.settings.pricing .candidates--price').text('$650 / mo');
    } else if(count <= 1800) {
      $('.settings.pricing .candidates--price').text('$725 / mo');
    } else if(count <= 2000) {
      $('.settings.pricing .candidates--price').text('$800 / mo');
    } else {
